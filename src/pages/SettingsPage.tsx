...
export default function SettingsPage() {
  ...
  const ALL_KEYS = ['products', 'customOrders', 'materials', 'accounts', 'cariTransactions', 'suppliers', 'sales', 'purchases', 'cashEntries', 'reminders', 'calendarEvents', 'materialTypes', 'whatsappConfig', 'firmaBilgileri', 'cashRegisters'];
